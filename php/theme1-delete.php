...
if ( !empty($_GET['message_id']) && empty($_POST['message_id']) ) {
	...
	if( empty($message_data) ) {
		...
		try {
			...
			$db->beginTransaction();
			//SQL作成
			$stmt = $db->prepare("DELETE FROM awareness WHERE seq = :seq");
			//値をセット
...
<div class="bread">
  <ol>
    ...
    <li><a href="theme1-view.php">閲覧ページ</a></li>
		<li><a href="theme1-delete.php">削除ページ</a></li>
  </ol>
</div>
...
<div class="conD">
	...
	<div class="control">
		...
		<button type="button" onclick="location.href='theme1-view.php'" class="green-button">キャンセル</button>
